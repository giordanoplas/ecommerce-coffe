...
const ProductCard = (props: ProductCardProps) => {
    ...
    return (
        <Link href={`/product/${product.slug}`} className="relative p-2 transition-all duration-100 rounded-lg hover:shadow">
            ...
            <p className="text-2xl font-bold text-center">{product.productName}</p>
